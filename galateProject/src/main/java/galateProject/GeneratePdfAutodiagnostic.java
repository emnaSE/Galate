...
public class GeneratePdfAutodiagnostic
{
    ...
    public static void generatePdfAutodiagnostic(final Long testId, final UUID uuid, final Long memberId) {
        try {
            ...
            final Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/galate?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "wqtqVSROVpdhilqI00");
