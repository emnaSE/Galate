...
import { FinalResultService } from './finalResultP2.service';
...
@Component({
  ...
  templateUrl: './finalResultP2.component.html',
})
export class FinalResultComponentP2  implements OnInit{
  pageActuel: number =1;
  finalResult:FinalResultP2[];
  finalcjatalogues:FinalcatalogueP2[];
  ...
  ngOnInit() {
    ...
    this.finalResultService.getAllCriterionsByTestMember(this.testId1 , this.memberId1).subscribe(
      data=>{
        this.object=data;
